                ...
                <div class="card-body">
                    <form @submit.prevent="submitForm('productDeleteForm')">
                        ...
                        <div class="mb-4">
                            ...
                            @{{ hasSelectedIncidents }} - test
                            <div class="row" v-if="hasSelectedIncidents">
                                <div class="col-lg-12">
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                hasPickedItem: function () {
                    console.log(Object.keys(this.projectData.bojajumi).length);
                    if(Object.keys(this.projectData.bojajumi).length > 0) {
                        this.hasSelectedIncidents = true;
                    } else{
                        this.hasSelectedIncidents = false;
                    }
                ...
                pickItem: function (type, item) {
                    ...
                    if(!this.projectData.bojajumi[type].includes(item)) {
                        ...
                        console.log(this.projectData.bojajumi[type]);
                    }
